                    ...
                    ForEach(unplaced, id: \.self) { item in
                        Button {
                            ...
                            Text(item)
                                ...
                                .padding(.vertical, 8)
                                .background(selectedCategory != nil ? Color.mint.opacity(0.1) : Color.themeSecondary.opacity(0.5))
    ...
    private func categoryBucket(_ name: String) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 6) {
            Button {
                ...
                .padding(10)
                .background(isSelected ? Color.mint.opacity(0.12) : Color.themeSecondary.opacity(0.5))
                .clipShape(RoundedRectangle(cornerRadius: 8))
                .overlay(
