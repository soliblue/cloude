...
struct MemorySectionCard: View {
    ...
    private var backgroundColor: Color {
        Color.themeSecondary.opacity(depth == 0 ? 1.0 : DS.Opacity.l)
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            Button {
                ...
                .padding(.vertical, depth == 0 ? DS.Spacing.l : DS.Spacing.s)
...
struct MemoryItemCard: View {
    ...
    private var backgroundColor: Color {
        Color.themeSecondary.opacity(depth == 0 ? DS.Opacity.l : DS.Opacity.l)
    }
