...
swiftc -parse-as-library -target "$(uname -m)-apple-macosx14.0" \
  ...
  src/Features/Chat/Logic/Chat{Goal,Model,Provider,Effort,PermissionMode,AgentAttention,Interaction,InteractionQuestion,InteractionStore,InteractionService,AttentionService}.swift \
