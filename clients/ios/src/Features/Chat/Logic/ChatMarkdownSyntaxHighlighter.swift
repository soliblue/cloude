...
enum ChatMarkdownSyntaxHighlighter {
    ...
    static let keywords: Set<String> = [
        ...
        "enum", "switch", "case", "break", "continue", "guard", "defer", "try", "catch", "throw",
        "throws", "async", "await", "private", "public", "internal", "static", "override", "final",
        "self", "super", "init", "deinit", "extension", "protocol", "where", "in", "as", "is",
        "nil", "true", "false",
        "function", "const", "export", "default", "from", "new", "this", "typeof", "instanceof",
        "undefined", "null",
        "def", "elif", "pass", "with", "lambda", "yield", "global", "nonlocal", "assert", "raise",
        "except", "finally", "and", "or", "not", "None", "True", "False",
        "fn", "mut", "pub", "mod", "use", "impl", "trait", "match", "loop", "move", "ref",
        "unsafe", "extern", "crate", "type", "dyn", "Some", "Ok", "Err",
        "package", "go", "chan", "select", "range", "fallthrough", "make", "map", "interface",
        "iota",
    ]

    static let types: Set<String> = [
        "String", "Int", "Double", "Float", "Bool", "Array", "Dictionary", "Set", "Optional",
        "Result", "Error", "View", "some", "any", "Self",
        ...
        while !remaining.isEmpty {
            ...
            if char.isNumber {
                ...
                while let c = remaining.first,
                    c.isNumber || c == "." || c == "x" || c == "b"
                        || (c.isHexDigit && number.contains("x"))
                {
                    number.append(c)
                    remaining = remaining.dropFirst()
                }
