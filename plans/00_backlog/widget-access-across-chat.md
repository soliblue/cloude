...
## Ideas
- Widget index/gallery view — collect all widgets from the conversation in one place
- Floating widget indicator showing count + tap to browse
- Widget pills in the scroll bar or a mini-map
- Filter/search by widget type
