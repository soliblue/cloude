...
## Overview
12-slide presentation generated using Claude Code (claude-opus-4-5) + Nano Banana Pro (Google's Gemini image model), following Anthropic brand guidelines.
...
```python
# Started with branded background, sent to Nano Banana to adapt
response = client.models.generate_content(
    model="models/nano-banana-pro-preview",
    contents=[prompt, Image.open("branded-background.png")],  # Reference image
