...
test('capability headers and ping advertise matching implemented Git routes', () => {
  ...
  assert.deepEqual(body(response).capabilities, ['codex', 'gitMutations', 'gitWorktrees', 'codexPlugins', 'codexCompaction', 'codexReview', 'codexShell', 'codexSections', 'codexTerminal', 'agentSchedules', 'codexActiveFork', 'codexIdempotentFork', 'codexHistoryPages', 'codexAttentionBatch'])
