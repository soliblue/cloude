...
swiftc "$ROOT/src/DaemonLifecycle.swift" "$ROOT/src/CodexClient.swift" "$ROOT/src/CodexSubscriptionPolicy.swift" \
  ...
  "$ROOT/src/Handlers/CodexTerminalHandler.swift" "$ROOT/src/Networking/HTTPServer.swift" "$ROOT/src/Networking/HTTPConnection.swift" \
  "$ROOT/src/Networking/HTTPResponse.swift" "$ROOT/src/Networking/HTTPRequest.swift" "$ROOT/src/Networking/HTTPRequestCancellation.swift" \
