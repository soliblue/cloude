...
| `target_metrics` | What the change should achieve |
| `implementation_summary` | Files changed + line counts (from solver) |
| `baseline_reports` | Paths to baseline measurement reports |
...
| Condition | Check |
|---|---|
| Claim supported by evidence | Metrics meet `target_metrics` |
