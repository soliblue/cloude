# Fix: Git diff infinite loading on Linux relay {arrow.clockwise}
<!-- priority: 10 -->
<!-- tags: git, relay -->

> Fixed git diff infinite loading by returning file path instead of repo path in relay response.
