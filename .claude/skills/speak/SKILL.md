...
# Custom output name
python3 .claude/skills/speak/generate.py "Chapter one" -o intro

# Adjust speed (0.5 = slow, 2.0 = fast)
python3 .claude/skills/speak/generate.py "Breaking news" -s 1.2

# All options together
python3 .claude/skills/speak/generate.py "The quick brown fox" -v bm_george -s 0.9 -o fox-narration
