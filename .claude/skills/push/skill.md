...
5. Ensure every code change has a matching plan in `plans/40_done/`. If a plan exists in `20_active/` or `30_testing/`, move it to `40_done/`. If no plan exists, create one directly in `40_done/`.
6. Stage changes.
